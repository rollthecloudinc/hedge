...
Cloud optimized back-end services following [principles of green software enigneering](https://principles.green/) for [Roll the Cloud Inc](https://github.com/rollthecloudinc).
